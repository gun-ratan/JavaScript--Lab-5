...
let emptyforimage = document.querySelector('#emptyforimage');
if (!emptyforimage) {
    emptyforimage = document.createElement('img');
    emptyforimage.id = 'emptyforimage';
    document.body.appendChild(emptyforimage);
}
...
function updateBatteryStatus(battery) {
    ...
    emptyforimage.src = `https://robohash.org/${level}.png?set=set3`;
    emptyforimage.alt = `Image representing battery level at ${level}%?set=set3`; 
}
